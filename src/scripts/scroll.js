...
class Item {
  constructor(el) {
    ...
    this.DOM = { el: el };
    // the inner image
    // this.DOM.title = this.DOM.el.querySelector(".project-title");
    this.DOM.subTitle = this.DOM.el.querySelector(".project-index");
    ...
    this.renderedStyles = {
      ...
      subTitleTranslationY: {
        ...
        current: 0,
        ease: 0.1,
        fromValue: Number(MathUtils.getRandomFloat(100, 200)),
        setValue: () => {
          const fromValue = this.renderedStyles.subTitleTranslationY.fromValue;
          const toValue = -1 * fromValue;
          const val = MathUtils.map(
            this.props.top - docScroll,
            winsize.height,
...
class SmoothScroll {
  constructor() {
    ...
    [...this.DOM.content.querySelectorAll(".item__img-wrap")].forEach(item =>
...
// ----- ANIMATIONS
const textLoader = new SplitText(document.querySelector(".text-container p"), {
  type: "chars"
});
const loaderContainer = document.querySelector(".loader");
const textIntro = new SplitText(document.querySelector(".home-main-text"), {
  type: "lines"
});
...
loaderTimelineBegin.staggerFrom(
  textLoader.chars,
  0.85,
  {
    y: 55,
